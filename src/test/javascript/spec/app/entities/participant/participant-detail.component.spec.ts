...
import { JhipsterfileuploadTestModule } from '../../../test.module';
    ...
    describe('Participant Management Detail Component', () => {
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [JhipsterfileuploadTestModule],
        ...
        describe('OnInit', () => {
            ...
            spyOn(service, 'find').and.returnValue(Observable.of(new Participant('aaa')));
            ...
            expect(comp.participant).toEqual(jasmine.objectContaining({id: 'aaa'}));
            });
        });
    });
